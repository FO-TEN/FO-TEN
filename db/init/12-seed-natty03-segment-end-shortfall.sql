...
--
-- natty01(db/init/10-seed-natty-first-onboarding.sql)과 같은 사람(팜 린)이 그 온보딩 결과로
...
-- natty02(11-seed-natty02-month7-shortfall.sql)와 같다.
--
...
--   설계 근거·날짜 규칙은 11-seed-natty02-month7-shortfall.sql 주석 참고. 다른 점은 달 수뿐이다:
