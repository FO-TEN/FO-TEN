<script setup>
import food from '../../assets/icons/cat_food.svg'
import coffee from '../../assets/icons/cat_coffee.svg'
import bag from '../../assets/icons/cat_bag.svg'
